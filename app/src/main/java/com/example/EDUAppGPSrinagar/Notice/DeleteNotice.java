...
public class DeleteNotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar=findViewById(R.id.deleteNoticePB);

        //toolbar
        toolbar = findViewById(R.id.noticeToolbarDelete);
        TextView textView = toolbar.findViewById((R.id.noticeToolbartvDelete));
        ImageButton imageButton = toolbar.findViewById(R.id.noticeToolbaribDelete);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               deleteNoticeRecycler.setAdapter(adapter);
                Toast.makeText(DeleteNotice.this, "Please Click image for Zoom in and Zoom out", Toast.LENGTH_LONG).show();
