...
import com.example.EDUAppGPSrinagar.Login_and_Register.ReadWriteUserDetails;
...
public class Teacher_Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFullName=findViewById(R.id.fullName_teacher);
        mEmail=findViewById(R.id.email_teacher);
        mPassword=findViewById(R.id.password_teacher);
        mMobile=findViewById(R.id.mobile_teacher);
        mClgPwd=findViewById(R.id.clg_Pwd_teacher);
        mRegisterLogin=findViewById(R.id.register_login_teacher);
        progressBar=findViewById(R.id.progressbar_teacher);
        registerbtn=findViewById(R.id.registerBtn_teacher);
        mBranch=findViewById(R.id.branch_teacher);
        mDob=findViewById(R.id.register_Dob_teacher);

        //RadioButton for Gender
        radioGroupRegisterGender=findViewById(R.id.register_radioGroup_teacher);
        ...
        mDob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //DatePicker Dialog
                picker=new DatePickerDialog(Teacher_Register.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        mRegisterLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Teacher_Register.this, Teacher_Login.class);
                ...
                if(task.isSuccessful()){
                    ...
                    referenceProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isComplete()) {
                                ...
                                Toast.makeText(Teacher_Register.this, "User registered Successfully.Please verify your email. ", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(Teacher_Register.this, "User registration failed.Please try again. ", Toast.LENGTH_LONG).show();
                            }
                    ...
                    try {
                       throw Objects.requireNonNull(task.getException());
                        ...
                        Toast.makeText(Teacher_Register.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                    // Hide progressbar whether user creation is successful or failed
                    progressBar.setVisibility(View.GONE);
                }
