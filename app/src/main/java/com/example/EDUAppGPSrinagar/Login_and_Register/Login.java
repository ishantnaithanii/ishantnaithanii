...
public class Login extends AppCompatActivity {
    ...
    private ImageView imageViewShowHidePwd,loginProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginPwd=findViewById(R.id.login_password);
        loginPwdLinear=findViewById(R.id.loginPwdLinear);
        loginProfile=findViewById(R.id.loginProfile);
        mClgPwd=findViewById(R.id.clg_password);
        ...
        //reset Password
        mForgotPswBtn=findViewById(R.id.login_forgotPwdBtn);
        ...
        imageViewShowHidePwd=findViewById(R.id.login_show_hide_pwd);
        ...
        ImageView imageViewShowClgPwd=findViewById(R.id.clg_show_hide_pwd);
    ...
    protected void onStart(){
        ...
        FirebaseUser firebaseUser = authProfile.getCurrentUser();
             if(firebaseUser.isEmailVerified()) {
                 ...
                 loginProfile.setVisibility(View.VISIBLE);
