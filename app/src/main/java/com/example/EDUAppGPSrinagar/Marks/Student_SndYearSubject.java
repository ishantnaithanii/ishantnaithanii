...
public class Student_SndYearSubject extends AppCompatActivity implements SubjectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_snd_year_subject);

        toolbar=findViewById(R.id.sndYearStudentToolbar);
        TextView textView=toolbar.findViewById((R.id.sndYearStudentToolbar_textView));
        ImageButton imageButton=toolbar.findViewById(R.id.sndYearStudentToolbar_btn);
    ...
    private void displayItemsCt24Sem() {
        recyclerView4Ct2=findViewById(R.id.studentRecyclerCt24thSub);
    ...
    private void displayItemsMid4Sem() {
        recyclerView4Mid=findViewById(R.id.studentRecyclerMid4thSub);
    ...
    private void displayItemsCt23Sem() {
        recyclerView3Ct2=findViewById(R.id.studentRecyclerCt23rdSub);
    ...
    private void displayItemsMid3Sem() {
        recyclerView3Mid=findViewById(R.id.studentRecyclerMid3rdSub);
    ...
    private void displayItems4Sem() {
        recyclerView4=findViewById(R.id.studentRecyclerView4thSub);
    ...
    private void displayItems3Sem() {
        recyclerView3=findViewById(R.id.studentRecyclerView3rdSub);
    ...
    public void onItemClicked(SubjectModel subjectModel) {
        Intent intent=new Intent(Student_SndYearSubject.this, StudentName2.class);
        ...
        Toast.makeText(this, subjectModel.getSubject(), Toast.LENGTH_SHORT).show();
