...
public class ReportSndYear extends AppCompatActivity implements SubjectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_snd_year);

        toolbar=findViewById(R.id.sndYearToolbarReport);
        TextView textView=toolbar.findViewById((R.id.sndYearToolbar_textViewReport));
        ImageButton imageButton=toolbar.findViewById(R.id.sndYearToolbar_btnReport);
    ...
    private void displayItemsCt24Sem() {
        recyclerView4Ct2=findViewById(R.id.recyclerCt24thSubReport);
    ...
    private void displayItemsMid4Sem() {
        recyclerView4Mid=findViewById(R.id.recyclerMid4thSubReport);
    ...
    private void displayItemsCt23Sem() {
        recyclerView3Ct2=findViewById(R.id.recyclerCt23rdSubReport);
    ...
    private void displayItemsMid3Sem() {
        recyclerView3Mid=findViewById(R.id.recyclerMid3rdSubReport);
    ...
    private void displayItems4Sem() {
        recyclerView4=findViewById(R.id.recyclerView4thSubReport);
    ...
    private void displayItems3Sem() {
        recyclerView3=findViewById(R.id.recyclerView3rdSubReport);
    ...
    public void onItemClicked(SubjectModel subjectModel) {
        Intent intent=new Intent(ReportSndYear.this, ReportMarksSnd.class);
