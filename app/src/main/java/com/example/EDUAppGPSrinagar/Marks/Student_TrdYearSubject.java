...
public class Student_TrdYearSubject extends AppCompatActivity implements SubjectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_trd_year_subject);
        toolbar=findViewById(R.id.trdYearToolbarStudent);
        TextView textView=toolbar.findViewById((R.id.trdYearToolbarTvStudent));
        ImageButton imageButton=toolbar.findViewById(R.id.trdYearToolbar_btnStudent);
    ...
    private void displayItemsCt26Sem() {
        recyclerView6Ct2=findViewById(R.id.recyclerCt2Sem6SubStudent);
    ...
    private void displayItemsMid6Sem() {
        recyclerView6Mid=findViewById(R.id.recyclerMidSem6SubStudent);
    ...
    private void displayItemsCt25Sem() {
        recyclerView5Ct2=findViewById(R.id.recyclerCt2Sem5SubStudent);
    ...
    private void displayItemsMid5Sem() {
        recyclerView5Mid=findViewById(R.id.recyclerMidSem5SubStudent);
    ...
    private void displayItems6Sem() {
        recyclerView6=findViewById(R.id.recyclerCt1Sem6SubStudent);
    ...
    private void displayItems5Sem() {
        recyclerView5=findViewById(R.id.recyclerCt1Sem5SubStudent);
    ...
    public void onItemClicked(SubjectModel subjectModel) {
        Intent intent=new Intent(Student_TrdYearSubject.this, StudentNameTrd.class);
