...
public class TrdYearSubject extends AppCompatActivity implements SubjectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trd_year_subject);

        toolbar=findViewById(R.id.trdYearToolbar);
        TextView textView=toolbar.findViewById((R.id.trdYearToolbar_textView));
        ImageButton imageButton=toolbar.findViewById(R.id.trdYearToolbar_btn);
    ...
    private void displayItemsCt26Sem() {
        recyclerView6Ct2=findViewById(R.id.recyclerCt2Sem6Sub);
    ...
    private void displayItemsMid6Sem() {
        recyclerView6Mid=findViewById(R.id.recyclerMidSem6Sub);
    ...
    private void displayItemsCt25Sem() {
        recyclerView5Ct2=findViewById(R.id.recyclerCt2Sem5Sub);
    ...
    private void displayItemsMid5Sem() {
        recyclerView5Mid=findViewById(R.id.recyclerMidSem5Sub);
    ...
    private void displayItems6Sem() {
        recyclerView6=findViewById(R.id.recyclerCt1Sem6Sub);
    ...
    private void displayItems5Sem() {
        recyclerView5=findViewById(R.id.recyclerCt1Sem5Sub);
    ...
    public void onItemClicked(SubjectModel subjectModel) {
        Intent intent=new Intent(TrdYearSubject.this, StudentMarksTrd.class);
